...
const testimonials = [
  {
    ...
    quote: "ClariSolve doesn't just build websites; they engineer digital gravity. Our engagement metrics doubled within weeks of the relaunch."
  },
  {
    name: "Marcus Chen",
  ...
  },
  {
    ...
    quote: "Working with ClariSolve is a masterclass in design execution. They operate at a standard of quality that redefines expectations."
  }
];
    ...
    <section className="py-32 bg-background relative overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h3 className="text-4xl md:text-5xl font-serif font-bold text-foreground">The ClariSolve Standard</h3>
        </motion.div>
