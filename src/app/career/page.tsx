    ...
    <div className="min-h-screen bg-[#0C0C0C] text-white">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-14 py-12 md:py-20">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <span className="text-white/50 text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase mb-4 inline-block">Join Our Team</span>
        ...
        <div className="space-y-4">
          {jobs.map((job, i) => (
            <motion.div
              ...
              className="group bg-[#141414] hover:bg-[#1a1a1a] border border-white/5 rounded-2xl p-6 md:p-8 transition-all duration-500 cursor-pointer"
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-white/30 border border-white/10 px-2 py-0.5 rounded-full">
                      {job.dept}
                    </span>
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold text-white mb-2 group-hover:text-[#ff4d00] transition-colors duration-500">
                    {job.title}
                  </h3>
                  <p className="text-white/50 text-sm leading-relaxed mb-4">
                    {job.desc}
                  </p>
                  <div className="flex flex-wrap items-center gap-4 text-xs md:text-sm text-white/40">
        ...
        <motion.div
          ...
          className="mt-16 p-8 md:p-12 bg-[#141414] rounded-2xl border border-white/5 text-center"
        >
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-3">Don&apos;t see a fit?</h3>
